...
Enlace al repositorio: https://github.com/Silvia452/GestionBancosMongo
...
```
java -Dspring.profiles.active=production -jar ./target/GestionBancosMongo-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/gestion-bancos-mongo
```
